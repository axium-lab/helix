...
**Domain**: files
**Status**: delta — replaces `openspec/specs/ports/spec.md` (file-store port portion) at archive time. Written as new spec since the port surface is entirely replaced by the `helix.files` namespace.
