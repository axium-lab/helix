...
**Domain**: responses
**Status**: delta — partially replaces `openspec/specs/core-types/spec.md` (the kept requirements are restructured here; REQs removed per proposal §6 are dropped). At archive time, this spec merges into `openspec/specs/responses/spec.md` (new path).
